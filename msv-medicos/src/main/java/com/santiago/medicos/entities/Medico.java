...
public void actualizarDisponibilidad(DisponibilidadMedico nuevaDisponibilidad) {
    ...
    public void validarDatos(
        ...
        StringCustomUtils.validarTamanio(apellidoPaterno, 1, 50, "El apellido paterno es requerido y debe contener entre 1 y 50 caracteres");
        StringCustomUtils.validarTamanio(apellidoMaterno, 1, 50, "El apellido materno es requerido y debe contener entre 1 y 50 caracteres");
        StringCustomUtils.validarTamanio(email, 1, 100, "El email es requerido y debe contener entre 1 y 100 caracteres");
        StringCustomUtils.validarTamanio(telefono, 10, 10, "El teléfono es requerido y debe contener exactamente 10 dígitos(0-9)");
        StringCustomUtils.validarTamanio(cedulaProfesional, 12, 12, "La cédula profesional es requerida y debe contener exactamente 12 caracteres");
        ValoresNumericosUtils.validarRangoShort(edad, (short) 18, (short) 100, "La edad es requerida y debe tener ser entre 18 y 100 años");
